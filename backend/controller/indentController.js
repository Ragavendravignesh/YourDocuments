...
const updateIndent = asyncHandler( async (req, res) => {
    ...
    if(indent) {
        ...
        indent.fiveHundredCount = req.body.fiveHundredCount || indent.fiveHundredCount;
        indent.thousandCount = req.body.thousandCount || indent.thousandCount;
        indent.fiveThousandCount = req.body.fiveThousandCount || indent.fiveThousandCount;
        indent.tenThousandCount = req.body.tenThousandCount || indent.tenThousandCount;
        indent.fifteenThousandCount = req.body.fifteenThousandCount || indent.fifteenThousandCount;
...
export { getIndents, getIndentByDate, updateIndent, deleteIndent, addIndent }